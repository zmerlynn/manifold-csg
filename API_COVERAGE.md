...
| C API function | Safe wrapper | Source |
|---|---|---|
...
| `manifold_smooth` | Not wrapped | Smooth constructor from half-edge indices |
| `manifold_smooth64` | Not wrapped | f64 variant of above |
| `manifold_level_set_seq` | Not wrapped | Sequential (non-parallel) level set |
...
| `manifold_boolean` | Not wrapped | Generic boolean (use typed methods or batch) |
...
| `manifold_status` | Internal | Used for error checking after construction |
| `manifold_as_original` | [`Manifold::as_original`](crates/manifold-csg/src/manifold.rs) | |
| `manifold_manifold_size` | Not wrapped | Byte-size query |
| `manifold_manifold_pair_size` | Not wrapped | Byte-size query |
...
| `manifold_get_meshgl_w_normals` | Not wrapped | Extract mesh with normals as extra props |
| `manifold_get_meshgl64_w_normals` | Not wrapped | f64 variant of above |
...
| `manifold_cross_section_boolean` | Not wrapped | Generic boolean (use typed methods) |
...
| `manifold_cross_section_of_simple_polygon` | Not wrapped | Lower-level single-polygon constructor |
| `manifold_cross_section_hull_polygons` | Not wrapped | Hull from polygon data |
| `manifold_cross_section_hull_simple_polygon` | Not wrapped | Hull from single polygon |
...
| `manifold_cross_section_size` | Not wrapped | Byte-size query |
...
| `manifold_meshgl_vert_properties_length` | Internal | Used by `vert_properties` |
| `manifold_meshgl_tri_length` | Internal | Used by `tri_verts` |
| `manifold_meshgl64_vert_properties_length` | Internal | Used by `vert_properties` |
| `manifold_meshgl64_tri_length` | Internal | Used by `tri_verts` |
| `manifold_meshgl_copy` | Not wrapped | |
| `manifold_meshgl64_copy` | Not wrapped | |
| `manifold_meshgl_w_options` | Not wrapped | Advanced: custom properties + tangents |
...
| `manifold_meshgl_merge` | Not wrapped | Merge table accessors |
...
| `manifold_meshgl_run_index` | Not wrapped | Run table accessors |
...
| `manifold_meshgl_face_id` | Not wrapped | Face ID accessors |
...
| `manifold_meshgl_size` | Not wrapped | Byte-size query |
| `manifold_meshgl64_size` | Not wrapped | |
| `manifold_meshgl64_read_obj` | Not wrapped | Lower-level OBJ (use `Manifold::from_obj`) |
| `manifold_meshgl64_write_obj` | Not wrapped | Lower-level OBJ (use `Manifold::to_obj`) |
...
| `manifold_triangulation_size` | Not used | Byte-size query |
...
| C API function | Safe wrapper | Notes |
|---|---|---|
...
| `manifold_box_size` | Not wrapped | Internal size query |
...
| Function group | Count | Status |
|---|---|---|
| `manifold_alloc_*` | 12 | Internal |
| `manifold_delete_*` | 12 | Internal (Drop) |
| `manifold_destruct_*` | 12 | Not used (alternative destructors) |

---

## Summary

| Category | Wrapped | Internal | Not wrapped |
|---|---|---|---|
| Manifold construction | 14 | 0 | 2 |
| Manifold booleans | 7 | 0 | 1 |
| Manifold transforms | 15 | 0 | 0 |
| Manifold queries | 13 | 0 | 3 |
| Manifold hull/decompose/mesh | 10 | 0 | 2 |
| CrossSection construction & booleans | 13 | 0 | 3 |
| CrossSection transforms & queries | 15 | 0 | 1 |
| MeshGL/MeshGL64 | 14 | 4 | 34 |
| Triangulation | 1 | 2 | 1 |
| Quality globals | 6 | 0 | 0 |
| Box3D (BoundingBox) | 16 | 0 | 1 |
| Rect2D (Rect) | 16 | 0 | 1 |
| Polygon helpers | 0 | 7 | 4 |
| Vector containers | 0 | 10 | 6 |
| Alloc/delete/destruct | 0 | 24 | 12 |
| **Total** | **140** | **47** | **71** |
